    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      {!kycCompleted && (
        <motion.div
          ...
          className="mb-6 bg-orange-50 border-l-4 border-orange-500 rounded-lg p-4"
        >
          <div className="flex items-start">
            <AlertTriangle className="h-6 w-6 text-orange-600 mr-3 flex-shrink-0 mt-0.5" />
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-orange-900">KYC Verification Required</h3>
              <p className="text-sm text-orange-700 mt-1">
                Your access to main features is restricted. Complete your KYC verification to unlock full functionality.
              </p>
              <button
