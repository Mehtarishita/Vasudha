  ...
  return (
    <div className="space-y-6 px-2 sm:px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Laboratory Results</h1>
          <p className="text-sm sm:text-base text-gray-600">View and manage laboratory test results</p>
        </div>
        
        <div className="flex items-center gap-2 sm:space-x-3">
          <button className="flex items-center space-x-1 sm:space-x-2 bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm">
            <ChartBarIcon className="h-4 w-4 sm:h-5 sm:w-5" />
            <span className="hidden sm:inline">Analytics</span>
          </button>
          
          <button className="flex items-center space-x-1 sm:space-x-2 bg-green-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm">
