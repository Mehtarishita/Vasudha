  ...
  <div className="bg-white rounded-2xl shadow border border-gray-100 p-8 mb-2">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-6">
          <div className="flex items-center gap-5">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center border-2 border-green-200">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-base text-gray-600">
                ...
                <span className="ml-2 px-2 py-1 text-xs font-semibold rounded bg-gray-200 text-gray-700">Barcode</span>
              </div>
          ...
          <div className="flex flex-col items-end gap-2">
            <span className={`inline-flex px-4 py-1 text-base font-semibold rounded-full ${getStatusColor(animal.healthStatus)}`}>{animal.healthStatus === 'healthy' ? 'Healthy' : 'Under Treatment'}</span>
